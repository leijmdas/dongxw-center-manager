...
import cn.kunlong.center.api.transformer.SysUserTransformer;
...
public class SysUserApiProvider implements SysUserApiService {
	...
	public PageResult<SysUserDTO> query(SysUserQueryDTO qpDTO) {
		cn.kunlong.center.biz.sys.domain.SysUser.QueryParam qp = BeanMapper.getInstance().map(qpDTO, cn.kunlong.center.biz.sys.domain.SysUser.QueryParam.class);
