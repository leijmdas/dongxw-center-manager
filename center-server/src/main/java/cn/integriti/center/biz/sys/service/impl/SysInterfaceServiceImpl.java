...
import cn.integriti.center.biz.listener.JobExceptionEvent;
import cn.integriti.center.biz.support.CurrentRequestContext;
import cn.integriti.center.biz.sys.dao.SysInterfaceMapper;
import cn.integriti.center.biz.sys.dao.SysInterfaceTriggerMapper;
...
import cn.integriti.center.biz.sys.service.SysDomainService;
import cn.integriti.center.biz.sys.service.SysInterfaceParamService;
import cn.integriti.center.biz.sys.service.SysInterfaceService;
...
public class SysInterfaceServiceImpl implements SysInterfaceService {
	...
	public void invokeService(final SysInterface intf) {
		...
		cn.integriti.center.biz.sys.domain.SysInterfaceParam param = new cn.integriti.center.biz.sys.domain.SysInterfaceParam();
		param.setInterfaceId(intf.getId());
		List<cn.integriti.center.biz.sys.domain.SysInterfaceParam> paramList = this.sysInterfaceParamService.findByNotNullProps(param);
		...
		for (cn.integriti.center.biz.sys.domain.SysInterfaceParam p : paramList) {
